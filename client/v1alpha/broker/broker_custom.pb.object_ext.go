...
func (o *ListenRequest_OpenRequest) MakeDiffFieldMask(other *ListenRequest_OpenRequest) *ListenRequest_OpenRequest_FieldMask {
	...
	if o.GetPortForwardingService().String() != other.GetPortForwardingService().String() {
...
func (o *ListenRequest_OpenRequest) Clone() *ListenRequest_OpenRequest {
	...
	if o.PortForwardingService == nil {
		result.PortForwardingService = nil
	} else if data, err := o.PortForwardingService.ProtoString(); err != nil {
		panic(err)
	} else {
		result.PortForwardingService = &port_forwarding_service.Reference{}
		if err := result.PortForwardingService.ParseProtoString(data); err != nil {
			panic(err)
		}
	}
	result.Name = o.Name
...
func (o *ListenRequest_OpenRequest) Merge(source *ListenRequest_OpenRequest) {
	if source.GetPortForwardingService() != nil {
		if data, err := source.GetPortForwardingService().ProtoString(); err != nil {
			panic(err)
		} else {
			o.PortForwardingService = &port_forwarding_service.Reference{}
			if err := o.PortForwardingService.ParseProtoString(data); err != nil {
				panic(err)
			}
		}
	} else {
